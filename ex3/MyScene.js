...
class MyScene extends CGFscene {
    ...
    initMaterials() {
        ...
        this.material4.setAmbient(0.7, 0.5, 0.3, 1.0);
    ...
    display() {
        ...
        this.setGlobalAmbientLight(this.globalLightIntensity, this.globalLightIntensity, this.globalLightIntensity,1);
